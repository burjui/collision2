...
@group(0) @binding(1) var<uniform> grid_min_y: f32;
@group(0) @binding(2) var<uniform> cell_size: f32;
@group(0) @binding(3) var<uniform> grid_size_x: u32;
@group(0) @binding(4) var<uniform> grid_size_y: u32;
