...
pub mod layout_asserts {
    ...
    const COMMON_CELL_POSITION_ASSERTS: () = {
        ...
        assert!(std::mem::align_of::<common::CellPosition>() == 8);
    ...
    const COMMON_DISPATCH_INDIRECT_ARGS_ASSERTS: () = {
        ...
        assert!(std::mem::align_of::<common::DispatchIndirectArgs>() == 4);
    ...
    const COMMON_COLLISION_CANDIDATE_ASSERTS: () = {
        ...
        assert!(std::mem::align_of::<common::CollisionCandidate>() == 4);
    ...
    const COMMON_A_A_B_B_ASSERTS: () = {
        ...
        assert!(std::mem::align_of::<common::AABB>() == 8);
    ...
    const INTEGRATE_BLACK_HOLE_ASSERTS: () = {
        ...
        assert!(std::mem::align_of::<integrate::BlackHole>() == 8);
...
pub mod common {
    ...
    pub struct CellPosition {
        ...
        pub offset: u32,
        pub _pad_offset: [u8; 8 - ::core::mem::size_of::<u32>()],
    }
    impl CellPosition {
        pub const fn new(cell: [u32; 2], offset: u32) -> Self {
            Self {
                cell,
                offset,
                _pad_offset: [0; 8 - ::core::mem::size_of::<u32>()],
            }
        }
    }
    #[repr(C)]
...
pub mod integrate {
    ...
    pub struct BlackHole {
        ...
        pub spin: f32,
        pub _pad_spin: [u8; 8 - ::core::mem::size_of::<f32>()],
    }
    impl BlackHole {
        pub const fn new(position: [f32; 2], radius: f32, mass: f32, spin: f32) -> Self {
            Self {
                ...
                mass,
                spin,
                _pad_spin: [0; 8 - ::core::mem::size_of::<f32>()],
            }
        }
    }
    #[repr(C)]
